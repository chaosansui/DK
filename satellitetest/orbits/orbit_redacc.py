...
def generate_redacc_orbit(orbital_elements: OrbitalElementsInterface) -> Orbit:
   # 确保必要的轨道元素已经被设置
   ...
   # 创建轨道
   redacc_orbit = Orbit.from_classical(Earth, semi_major_axis, eccentricity, inclination, raan, arg_periapsis,
